const decks = [
  {
    title: "Media Kit & Company Profile Presentation",
    ...
    thumb: "img/thumbnail/media-kit.jpeg",
    year: "2024",
    client: "",
    tags: ["PowerPoint", "Corporate", "Branding"],
    assets: [
      { label: "View project", href: "decks/media-kit.html" }
    ]
  },
  {
    title: "Healthcare Corporate Presentation",
    category: "Presentations",
    ...
    thumb: "img/thumbnail/healthcare.jpeg",
    year: "2024",
    client: "",
    tags: ["PowerPoint", "Healthcare", "Corporate"],
    assets: [
      { label: "View project", href: "decks/healthcare.html" }
    ]
  },
  {
    title: "Business Infographic Presentation — Diagrams & Visuals",
    category: "Presentations",
    ...
    thumb: "img/thumbnail/business-infographic.jpeg",
    year: "2023",
    client: "",
    tags: ["Infographics", "Diagrams", "Data Viz"],
    assets: [
      { label: "View project", href: "decks/business-infographic.html" }
    ]
  },
  {
    title: "Iceberg Infographic Presentation — Hidden Layers & Comparisons",
    category: "Presentations",
    ...
    thumb: "img/thumbnail/iceberg.jpeg",
    year: "2023",
    client: "",
    tags: ["Infographics", "Diagrams", "Visual Storytelling"],
    assets: [
      { label: "View project", href: "decks/iceberg.html" }
    ]
  },
  {
    title: "Insurance Slide Deck",
    category: "Presentations",
    ...
    thumb: "img/thumbnail/insurance.jpeg",
    year: "2024",
    client: "",
    tags: ["PowerPoint", "Insurance", "Corporate"],
    assets: [
      { label: "View project", href: "decks/insurance.html" }
    ]
  }
];